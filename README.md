...
> R12.5 and R13 are closed research gates. The original R14 infrastructure
candidate `b6ebc780…` passed its technical gates, but pre-data review reopened
R14.1 to close execution details, publication-scale sampling and streaming/data
policy before the final tag. No v3 suite is production-ready or security-stable.
...
| R14.1 execution/publication/data refreeze | **ACTIVE before data** |
| R15 confirmatory scientific campaign | **blocked until R14.1 PASS + exact tag** |
...
- [R15 confirmatory campaign plan](docs/r15-confirmatory-campaign-plan.md)
- [R15 traceability](docs/traceability-v3-r15.md)
