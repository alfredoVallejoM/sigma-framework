...
| EXP-11R | attempts/verification cost | geometric calibration and zero protocol invariant failures | predicate × challenge reuse × difficulty × t × k × nonce workers × repetition | protocol attacks, censoring and deterministic multiprocess nonce batches/speedup implemented; scaled execution pending |
