...
FROZEN_PATHS = (
    ...
    "experiments/r15_harness.py",
    "scripts/check_r15_harness.py",
    "experiments/r15_structural_shadow.py",
    ...
    "experiments/r15_stat_streams.py",
    "experiments/r15_stat_shadow.py",
    "scripts/check_r15_stat_shadow.py",
    "experiments/r15_analysis_shadow.py",
    "scripts/check_r15_analysis_shadow.py",
