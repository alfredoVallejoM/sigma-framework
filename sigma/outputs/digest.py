...
class SigmaDigestV2:
    ...
    def metadata(self) -> Dict[str, Any]:
        return {
            ...
            "wire_frozen": get_suite(self.context.suite_id).wire_frozen,
            "vectors_frozen": get_suite(self.context.suite_id).vectors_frozen,
            "suite_stable": get_suite(self.context.suite_id).suite_stable,
            "security_reviewed": get_suite(self.context.suite_id).security_reviewed,
