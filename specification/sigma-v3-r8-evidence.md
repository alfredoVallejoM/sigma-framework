...
`ExplicitAuditEvidenceV3` es un envelope distinto con magic `SIGMA3EA`: (1)
`EXPLICIT_BINDING (0x0302)`, (2) domain EVIDENCE, (3) digest implícito completo,
(4) `PersistentBinding`. No es intercambiable con el digest principal y comprueba
